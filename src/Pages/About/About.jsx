    ...
    <>
      ...
      <main id="about">
        <section id="aboutContent">
          ...
          <h1 className="aboutHeader">Welcome to Illumiscore.com</h1>
          <p>
          ...
          <p>
            At Illumiscore.com, we envision a world where sports fans can
            connect even more deeply with their favorite teams, bringing the
            excitement of the game right into their homes. We believe that every
            score should be celebrated in style, and our innovative platform
            makes it possible for you to do just that.
          </p>

          <h2 className="aboutHeader">The Technology Behind the Magic</h2>
          <p>
            Our platform integrates the world of sports and smart lighting. Our
            C# process leverages the AllSportsAPI to fetch live MLB Baseball
            scores in real-time. When your favorite team scores a run, our
            system springs into action.
          </p>
          <p>
            Using MongoDB Realm, we've created a robust and efficient system.
            When a team scores, a MongoDB Realm function is triggered to
            identify the lights associated with that team. Then, through the
            LIFX API, we command your LIFX lights to perform a mesmerizing light
            show, perfectly synchronizing with the team's colors. It's a
            breathtaking spectacle that brings the stadium atmosphere to your
            living room.
          </p>
          ...
          <p>
            ...
            take your privacy seriously, and your LIFX light API keys, light
            IDs, and names are securely stored to ensure your peace of mind.
          </p>
          <p>
            ...
            . We're here to make sure your journey with Illumiscore.com is as
            smooth as possible.
          </p>

          <h2 className="aboutHeader">
            From User Profiles to Game-Day Thrills
          </h2>
          <p>
            ...
            team scores – your LIFX lights will come alive, flashing in a
            symphony of colors that mirror the team's success. It's a
            celebration like no other, and you're at the center of it all.
          </p>

          <h2 className="aboutHeader">The Tech Stack</h2>
          <p>
            Our platform boasts a dynamic and robust tech stack. The frontend is
            powered by React.js, ensuring a seamless and engaging user
            experience. MongoDB serves as our database backbone, securely
            storing your essential information, such as your LIFX light API keys
            and MLB team preferences.
          </p>
          ...
          <p>
            ...
            verifying your Google token against your unique sub number,
            providing a secure and personalized environment for you to enjoy.
          </p>

          <h2 className="aboutHeader">
            Join Us in Illuminating the Game-Day Experience
          </h2>
          <p>
            At Illumiscore.com, we're passionate about bringing the excitement
            of the game to your living space. Every score, every homer, every
            run – they're all moments worth celebrating. Join us in this journey
            of fusing sports and technology, lighting up your game-day
            experience, one LIFX light at a time.
          </p>
