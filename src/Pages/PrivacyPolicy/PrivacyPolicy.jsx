    ...
    <>
      ...
      <main id="privacyPolicy">
        <section id="privacyPolicyContent">
          ...
          <p className="privacyPolicyPara">
            We collect the following information to provide our services: LIFX
            API keys, Light IDs, Light Names, MLB team preferences, and JWT
            credential sub. This data is used to synchronize lighting effects
            with MLB team scores and offer a personalized user experience.
          </p>
          ...
          <p className="privacyPolicyPara">
            We take measures to protect your data, including encryption and
            secure storage. While we strive to ensure the safety of your data,
          ...
          <p className="privacyPolicyPara">
            ...
            longer periods if required by law or for legitimate business
            purposes.
          </p>
          ...
          <p className="privacyPolicyPara">
            ...
            this page, and the updated Privacy Policy will be effective
